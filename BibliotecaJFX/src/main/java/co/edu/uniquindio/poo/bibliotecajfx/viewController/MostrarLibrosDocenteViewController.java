...
public class MostrarLibrosDocenteViewController {
    MostrarLibrosDocenteController mostrarLibrosDocenteController;
    ...
    @FXML
    private TableView<Libro> tablaLibrosDocente;
    ...
    private void initView() {
        ...
        tablaLibrosDocente.getItems().clear();


        tablaLibrosDocente.setItems(listLibrosDocente);
    ...
    public void setApp(App app) {
        this.app = app;
        mostrarLibrosDocenteController = new MostrarLibrosDocenteController(App.biblioteca);
        initView();
    }
    ...
    private void obtenerListaLibros() {
        listLibrosDocente.addAll(mostrarLibrosDocenteController.mostrarLibrosDocente());
    }
}
