...
public class LibrosSinPrestamosViewController {
    LibrosSinPrestamosController librosSinPrestamosController;
    ObservableList<Libro> listLibrosSinPrestamos = FXCollections.observableArrayList();
    App app;
    @FXML
    private URL url;
    @FXML
    ...
    @FXML
    private TableView<Libro> tablaLibrosSinPrestamos;
    ...
    private void initView() {
        ...
        tablaLibrosSinPrestamos.getItems().clear();


        tablaLibrosSinPrestamos.setItems(listLibrosSinPrestamos);
    ...
    public void setApp(App app) {
        this.app = app;
        librosSinPrestamosController = new LibrosSinPrestamosController(App.administrador);
        initView();
    }
    ...
    private void obtenerListaLibros() {
        listLibrosSinPrestamos.addAll(librosSinPrestamosController.librosSinPrestamos());
    }
}
