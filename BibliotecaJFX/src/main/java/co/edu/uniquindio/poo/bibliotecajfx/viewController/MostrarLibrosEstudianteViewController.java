...
import co.edu.uniquindio.poo.bibliotecajfx.controller.MostrarLibrosEstudianteController;
...
public class MostrarLibrosEstudianteViewController {
    MostrarLibrosEstudianteController mostrarLibrosEstudianteController;
    ObservableList<Libro> listLibrosEstudiante = FXCollections.observableArrayList();
    App app;
    @FXML
    private URL url;
    @FXML
    ...
    @FXML
    private TableView<Libro> tablaLibrosEstudiante;
    ...
    private void initView() {
        ...
        tablaLibrosEstudiante.getItems().clear();


        tablaLibrosEstudiante.setItems(listLibrosEstudiante);
    ...
    public void setApp(App app) {
        this.app = app;
        mostrarLibrosEstudianteController = new MostrarLibrosEstudianteController(App.biblioteca);
        initView();
    }
    ...
    private void obtenerListaLibros() {
        listLibrosEstudiante.addAll(mostrarLibrosEstudianteController.mostrarLibrosEstudiante());
    }
}
